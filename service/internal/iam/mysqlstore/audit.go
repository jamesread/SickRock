...
func (s *MySQL) GetMyPermissionsAudit(ctx context.Context, userID int) ([]string, []string, bool, []store.MyPermissionAuditRow, error) {
...
func (s *MySQL) finishPermissionsAudit(ctx context.Context, userID int, groupNames []string) ([]string, []string, bool, []store.MyPermissionAuditRow, error) {
...
func (s *MySQL) buildAuditRows(ctx context.Context, userID int, effective *rbac.EffectiveRBAC) ([]store.MyPermissionAuditRow, error) {
...
func (s *MySQL) grantingGroupsByPerm(ctx context.Context, userID int) (map[string][]string, error) {
