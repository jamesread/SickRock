...
func (s *MySQL) ListUserGroups(ctx context.Context) ([]store.UserGroupRow, error) {
	return s.queryUserGroups(ctx, userGroupSelectSQL()+` ORDER BY g.name`)
}

func (s *MySQL) GetUserGroupByName(ctx context.Context, name string) (*store.UserGroupRow, error) {
	return s.getUserGroup(ctx, userGroupSelectSQL()+` WHERE g.name = ?`, name)
}

func (s *MySQL) GetUserGroupByID(ctx context.Context, id int) (*store.UserGroupRow, error) {
	return s.getUserGroup(ctx, userGroupSelectSQL()+` WHERE g.id = ?`, id)
}

func (s *MySQL) getUserGroup(ctx context.Context, q string, arg any) (*store.UserGroupRow, error) {
...
func (s *MySQL) queryUserGroups(ctx context.Context, q string, args ...any) ([]store.UserGroupRow, error) {
...
func (s *MySQL) CreateUserGroup(ctx context.Context, name string) (int, error) {
	res, err := s.db.ExecContext(ctx, `INSERT INTO user_groups (name, created_at, updated_at) VALUES (?, NOW(3), NOW(3))`, name)
	if err != nil {
...
func (s *MySQL) userGroupNameByID(ctx context.Context, id int) (string, error) {
	var name string
...
func (s *MySQL) DeleteUserGroup(ctx context.Context, id int) error {
...
func (s *MySQL) ListUserGroupMemberIDs(ctx context.Context, groupID int) ([]int, error) {
...
func (s *MySQL) ListUserGroupIDsForUser(ctx context.Context, userID int) ([]int, error) {
...
func (s *MySQL) SetUserGroupMembers(ctx context.Context, groupID int, userIDs []int) error {
