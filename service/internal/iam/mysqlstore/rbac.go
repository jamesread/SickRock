...
func (s *MySQL) LoadEffectiveRBAC(ctx context.Context, userID int) (*rbac.EffectiveRBAC, error) {
...
func (s *MySQL) userIsSuperuser(ctx context.Context, userID int) (bool, error) {
	var n int
...
func (s *MySQL) loadPermissionSet(ctx context.Context, userID int, isSuper bool) (map[string]bool, error) {
...
func (s *MySQL) ListRBACPermissions(ctx context.Context) ([]store.RBACPermissionRow, error) {
...
func (s *MySQL) GetRBACRole(ctx context.Context, id int) (*store.RBACRoleRow, error) {
	return s.loadRBACRole(ctx, id)
}

func (s *MySQL) loadRBACRole(ctx context.Context, id int) (*store.RBACRoleRow, error) {
...
func (s *MySQL) scanRBACRole(ctx context.Context, id int) (*store.RBACRoleRow, error) {
...
func (s *MySQL) fillRBACRole(ctx context.Context, role *store.RBACRoleRow) error {
...
func (s *MySQL) ListRBACRoles(ctx context.Context) ([]store.RBACRoleRow, error) {
...
func (s *MySQL) rbacRoleNameByID(ctx context.Context, id int) (string, error) {
	var name string
...
func (s *MySQL) setRBACRolePermissionsTx(ctx context.Context, tx *sql.Tx, roleID int, permissionIDs []int) error {
...
func (s *MySQL) CreateRBACRole(ctx context.Context, name, description string, permissionIDs []int) (int, error) {
...
func (s *MySQL) insertRoleWithPerms(ctx context.Context, tx *sql.Tx, name, description string, permissionIDs []int) (int, error) {
	res, err := tx.ExecContext(ctx, `INSERT INTO rbac_roles (name, description, created_at, updated_at) VALUES (?, ?, NOW(3), NOW(3))`, name, description)
	if err != nil {
...
func (s *MySQL) UpdateRBACRole(ctx context.Context, id int, name, description string, permissionIDs []int) error {
...
func (s *MySQL) updateRBACRoleTx(ctx context.Context, id int, name, description string, permissionIDs []int, curName string) error {
	tx, err := s.db.BeginTx(ctx, nil)
	if err != nil {
	...
	if err := execTxOp(ctx, tx, "update rbac role",
		`UPDATE rbac_roles SET name = ?, description = ?, updated_at = NOW(3) WHERE id = ?`,
...
func maybeSetRolePerms(ctx context.Context, s *MySQL, tx *sql.Tx, id int, permissionIDs []int, curName string) error {
...
func (s *MySQL) DeleteRBACRole(ctx context.Context, id int) error {
...
func (s *MySQL) SetRBACRolePermissions(ctx context.Context, roleID int, permissionIDs []int) error {
...
func (s *MySQL) replaceRolePermissions(ctx context.Context, roleID int, permissionIDs []int) error {
	tx, err := s.db.BeginTx(ctx, nil)
	if err != nil {
...
func (s *MySQL) ListRolePermissionIDs(ctx context.Context, roleID int) ([]int, error) {
...
func (s *MySQL) ListPermissionRoleNames(ctx context.Context, permissionID int) ([]string, error) {
...
func (s *MySQL) GetUserRbacRoleNames(ctx context.Context, userID int) ([]string, error) {
	names, err := s.queryStrings(ctx,
...
func (s *MySQL) GetUserGroupRbacRoleIDs(ctx context.Context, groupID int) ([]int, error) {
...
func (s *MySQL) SetUserGroupRbacRoles(ctx context.Context, groupID int, roleIDs []int) error {
	tx, err := s.db.BeginTx(ctx, nil)
	if err != nil {
...
func (s *MySQL) ListRbacRoleGroupNames(ctx context.Context, roleID int) ([]string, error) {
	names, err := s.queryStrings(ctx,
